...
if __name__ == '__main__':
    ...
    # Load voltages
    filepath = os.path.join('Results', f'n{n}', f'swissroll_voltage_embedding_n{n}_lvl{embedding_lvl}.npz')
    ...
    ax.scatter(source_centers[:, 0], source_centers[:, 1], source_centers[:, 2], marker='x', s=155, color='red')
    ...
    plt.show()
    ### Laplacian eigenmaps
    #filepath = os.path.join('Results', f'n{n}', f'laplacian_eigenmaps_embedding_n{n}.npz')
